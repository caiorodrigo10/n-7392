...
const MonthCard = ({ month }: { month: string }) => (
  <Card className="bg-white p-4">
    <div className="flex justify-between items-start mb-6">
      <span className="text-sm font-medium text-neutral-900">{month}</span>
      <span className="text-xs text-blue-500">In Progress</span>
    </div>
    <div className="flex justify-between items-baseline mb-1">
      <div>
        <p className="text-neutral-500 text-sm mb-1">Achieved</p>
        <p className="text-lg font-medium">$0.00</p>
      </div>
      <div className="text-right">
        <p className="text-neutral-500 text-sm mb-1">Goal</p>
        <p className="text-lg font-medium">$1,000.00</p>
      </div>
    </div>
    <div className="text-right text-sm text-neutral-500">0%</div>
  </Card>
);
